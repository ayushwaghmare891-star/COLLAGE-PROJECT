...
export function SearchAndFilter({
  ...
  return (
    <div className="mb-8 space-y-4">
      ...
      {/* Filter Options */}
      {showFilters && (
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 animate-in fade-in slide-in-from-top-2">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition-all"
              >
