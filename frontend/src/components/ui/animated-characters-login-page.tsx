...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-2">
      {/* Left Login Section */}
      <div className="flex items-center justify-center p-8 bg-background order-first">
      ...
      <div className="relative flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground order-last">
